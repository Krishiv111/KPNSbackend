...
public class CancerApiController {
     ...
     */
    @GetMapping("/")
    public ResponseEntity<List<Cancer>> getJokes() {
     ...
     */
    @PostMapping("/like/{id}")
    public ResponseEntity<Cancer> setLike(@PathVariable long id) {
        /* 
        ...
        */
        ...
        if (optional.isPresent()) {  // Good ID
            Cancer joke = optional.get();  // value from findByID
     ...
     */
    @PostMapping("/jeer/{id}")
    public ResponseEntity<Cancer> setJeer(@PathVariable long id) {
        Optional<Cancer> optional = repository.findById(id);
        if (optional.isPresent()) {  // Good ID
            Cancer joke = optional.get();
